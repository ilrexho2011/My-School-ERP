...
class Sms_model extends CI_Model {
    ...
    // DERGIMI I SMS NEPERMJET CLICKATELL API
    function send_sms_via_clickatell($message = '' , $reciever_phone = '') {
        ...
        if ($sess[0] == "OK") {
            ...
            if ($send[0] == "ID") {
                echo "dergimi i mesazhit u krye me ID: ". $send[1];
            } else {
                echo "dergimi i mesazhit deshtoi";
            }
        } else {
            echo "Deshtim i Autentikimit: ". $ret[0];
        }
    }
    
    
    // DERGIMI I SMS NEPERMJET TWILIO API
    function send_sms_via_twilio($message = '' , $reciever_phone = '') {
        
        // NGARKO LIBRARINE E TWILIO
