                    ...
                    <?php echo form_open(base_url() . 'index.php?accountant/secretary/do_update/'.$row['secretary_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls" style="width:210px;">
                                    <img id="blah" src="<?php echo $this->crud_model->get_image_url('secretary',$row['secretary_id']);?>" alt="imazhi juaj" height="100" />
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-gray"><?php echo get_phrase('edit_secretary');?></button>
                        </div>
                    </form>
                    <?php endforeach;?>
                </div>
