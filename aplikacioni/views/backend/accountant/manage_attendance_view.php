...
<?php echo form_open(base_url() . 'index.php?accountant/attendance_selector/'); ?>
<div class="row">
...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <?php echo form_open(base_url() . 'index.php?accountant/attendance_update/' . $class_id . '/' . $section_id . '/' . $timestamp); ?>
