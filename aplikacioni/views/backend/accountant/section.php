		...
		<div class="tabs-vertical-env">
			...
			?>
				<li class="<?php if ($row['class_id'] == $class_id) echo 'active';?>">
					<a href="<?php echo base_url();?>index.php?accountant/section/<?php echo $row['class_id'];?>">
								...
								<td>
									<div class="btn-group">
		                                ...
		                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
		                                    ...
		                                    <!-- LINKU I FSHIRJES -->
		                                    <li>
		                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?accountant/sections/delete/<?php echo $row['section_id'];?>');">
