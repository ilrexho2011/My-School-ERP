<?php 
	...
	$running_year       =	$this->db->get_where('settings' , array('type'=>'running_year'))->row()->description;
        if($month == 1) $m = 'Janar';
        else if($month == 2) $m='Shkurt';
        else if($month == 3) $m='Mars';
        else if($month == 4) $m='Prill';
        else if($month == 5) $m='Maj';
        else if($month == 6) $m='Qershor';
        else if($month == 7) $m='Korrik';
        else if($month == 8) $m='Gusht';
        else if($month == 9) $m='Shtator';
        else if($month == 10) $m='Tetor';
        else if($month == 11) $m='Nentor';
        else if($month == 12) $m='Dhjetor';
?>
<div id="print">
...
<script type="text/javascript">
    ...
    function Popup(data) 
    {
        ...
        mywindow.document.close(); // e nevojshme per IE >= 10
        mywindow.focus(); // e nevojshme per IE >= 10
