		...
		<div class="tabs-vertical-env">
			...
			?>
				<li class="<?php if ($row['class_id'] == $class_id) echo 'active';?>">
					<a href="<?php echo base_url();?>index.php?accountant/academic_syllabus/<?php echo $row['class_id'];?>">
							...
							<tr>
								...
								<td align="center">
									<a class="btn btn-default btn-xs"
										href="<?php echo base_url();?>index.php?accountant/download_academic_syllabus/<?php echo $row['academic_syllabus_code'];?>">
