...
<div class="row">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
		...
		<tbody>
        	<form method="post" action="<?php echo base_url();?>index.php?accountant/attendance_selector" class="form">
            	<tr class="gradeA">
                    <td>
                    ...
                    <td>
                    	<select name="month" class="form-control selectboxit">
							...
							for($i=1;$i<=12;$i++):
								if($i==1)$m='janar';
								else if($i==2)$m='shkurt';
								else if($i==3)$m='mars';
								else if($i==4)$m='prill';
								else if($i==5)$m='maj';
								else if($i==6)$m='qershor';
								else if($i==7)$m='korrik';
								else if($i==8)$m='gusht';
								else if($i==9)$m='shtator';
								else if($i==10)$m='tetor';
								else if($i==11)$m='nentor';
								else if($i==12)$m='dhjetor';
							?>
                            	<option value="<?php echo $i;?>"
                ...
                <?php 
                    $students   =   $this->db->get_where('enroll' , array(
                        ...
                        <tr class="gradeA">
                            ...
                            <?php 
                                //FUTJA E TE DHENAVE BOSH PER FREKUENTIMIN E NXENESVE NESE NUK KA TE DHENA
                                ...
                                //SHFAQ OPSIONIN E EDITIMIT PER GJENDJEN E FREKUENTIMIT
...
<!-- FORMA E DERGIMIT TE FREKUENTIMIT TE NXENESIT NIS KETU -->
<form method="post" 
    action="<?php echo base_url();?>index.php?accountant/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id.'/'.$section_id.'/'.$session;?>">
    <div class="col-sm-offset-3 col-md-6">
        <table  class="table table-bordered">
    		<thead>
    			<tr class="gradeA">
    					...
    					<td align="center">
                        	...
                        	?>
                                ...
                                <select name="status_<?php echo $row['student_id'];?>" class="form-control" style="width:100px; float:left;">
                                    ...
                                    <option value="1" <?php if($status == 1)echo 'selected="selected"';?>>Prezent</option>
                                    <option value="2" <?php if($status == 2)echo 'selected="selected"';?>>Jo Prezent</option>
                                </select>
        ...
        <center>
            <input type="submit" class="btn btn-info" value="Ruaj ndryshimet">
        </center>
    </div>
</form>
