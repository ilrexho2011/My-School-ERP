...
<div class="mail-env">
    ...
    <div class="mail-sidebar" style="min-height: 800px;">
        ...
        <!-- butoni i kompozimit te Emailit te ri -->
        <div class="mail-sidebar-row hidden-xs">
            <a href="<?php echo base_url(); ?>index.php?accountant/message/message_new" class="btn btn-success btn-icon btn-block">
                <?php echo get_phrase('new_message'); ?>
                <i class="entypo-pencil"></i>
            </a>
        </div>

        <!-- lista e mesazheve ne inboxin e perdoruesit -->
        <ul class="mail-menu">
            ...
            foreach ($message_threads as $row):
                ...
                // percaktohen perdoruesit qe dialogojne
                ...
                <li class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code']) echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>index.php?accountant/message/message_read/<?php echo $row['message_thread_code']; ?>" style="padding:12px;">
