...
<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        ...
        <?php echo form_open(base_url() . 'index.php?accountant/class_routine/do_update/'.$row['class_routine_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="day" class="form-control selectboxit">
                            <option value="E SHTUNE" 	<?php if($row['day']=='E SHTUNE')echo 'selected="selected"';?>>e shtune</option>
                            <option value="E DIEL" 		<?php if($row['day']=='E DIEL')echo 'selected="selected"';?>>e diel</option>
                            <option value="E HENE" 		<?php if($row['day']=='E HENE')echo 'selected="selected"';?>>e hene</option>
                            <option value="E MARTE" 	<?php if($row['day']=='E MARTE')echo 'selected="selected"';?>>e marte</option>
                            <option value="E MERKURE" 	<?php if($row['day']=='E MERKURE')echo 'selected="selected"';?>>e merkure</option>
                            <option value="E ENJTE" 	<?php if($row['day']=='E ENJTE')echo 'selected="selected"';?>>e enjte</option>
                            <option value="E PREMTE" 	<?php if($row['day']=='E PREMTE')echo 'selected="selected"';?>>e premte</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    function section_subject_select(class_id , class_routine_id) {
        $.ajax({
            url: '<?php echo base_url();?>index.php?accountant/section_subject_edit/' + class_id + '/' + class_routine_id ,
