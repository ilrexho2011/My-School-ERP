<hr />
<div class="row">
	<?php echo form_open(base_url() . 'index.php?accountant/exam_marks_sms/send_sms');?>
        ...
        <div class="col-md-3">
          ...
          <div class="col-md-3" style="margin-top: 20px;">
              <button type="submit" class="btn btn-primary"><?php echo get_phrase('send_marks');?> me SMS</button>
          </div>
