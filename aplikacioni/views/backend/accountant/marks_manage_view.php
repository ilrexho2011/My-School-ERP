<hr />
<?php echo form_open(base_url() . 'index.php?accountant/marks_selector');?>
<div class="row">
...
<div class="row">
	...
	<div class="col-md-8">
		...
		<?php echo form_open(base_url() . 'index.php?accountant/marks_update/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id);?>
...
<script type="text/javascript">
	...
	$.ajax({
            url: '<?php echo base_url();?>index.php?accountant/marks_get_subject/' + class_id ,
