        ...
        <div class="login-container">
            ...
            <div class="login-header login-caret">
                ...
                <div class="login-content" style="width:100%;">
                    ...
                    <p class="description">Futni Emailin tuaj per Zerimin e Password-it.</p>

                    <!-- indikatori i progresit -->
                    <div class="login-progressbar-indicator">
                        <h3>43%</h3>
                        <span>po zerohet passwordi...</span>
                    </div>
                </div>
            ...
            <div class="login-form">
                ...
                <div class="login-content">
                    ...
                    <div class="form-login-error">
                        <h3>Email i pavlefshem</h3>
                        <p>Ju lutemi futni nje Email te sakte!</p>
                    </div>
                    <form method="post" role="form" id="form_forgot_password">

                        <div class="form-forgotpassword-success">
                            <i class="entypo-check"></i>
                            <h3>Email-i i Zerimit u dergua.</h3>
                            <p>Ju lutemi kontrolloni inbox-in e Emailit, ku jane derguar instruksionet e Zerimit te password-it!</p>
                        </div>
