...
class Secretary extends CI_Controller
{
	...
	function __construct()
	{
       ...
       /*kontrollimi i cache-se*/
		$this->output->set_header('Cache-Control: no-store, no-cache, must-revalidate, post-check=0, pre-check=0');
		$this->output->set_header('Pragma: no-cache');
		
    }
    
    /*     * * funksioni default, redirekton ne faqen login nese asnje sekretar nuk eshte loguar ende ** */
    ...
    /***PLATFORMA E SEKRETARIT***/
    function dashboard()
    {
        if ($this->session->userdata('secretary_login') != 1)
            redirect(base_url(), 'refresh');
        $page_data['page_name']  = 'dashboard';
        $page_data['page_title'] = get_phrase('secretary_dashboard');
        $this->load->view('backend/index', $page_data);
    }
    
    /****MENAXHIMI I NXENESVE*****/
	...
	function student_bulk_add($param1 = '')
	{
        ...
        if($param1 == 'add_bulk_student') {
            ...
            for($i = 0; $i < $student_entries; $i++) {
                ...
                //kontrollohet validiteti, nese rreshti (name, email, password) eshte bosh ose jo
            ...
            redirect(base_url() . 'index.php?secretary/student_information/' . $this->input->post('class_id') , 'refresh');
        }			
    ...
    function get_sections($class_id)
    {
        ...
        $this->load->view('backend/secretary/student_bulk_add_sections' , $page_data);
    }
    ...
    function student_marksheet_print_view($student_id , $exam_id) {
        ...
        $this->load->view('backend/secretary/student_marksheet_print_view', $page_data);
    }
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->email_model->account_opening_email('student', $data['email']); //DERGOHET EMAIL
            redirect(base_url() . 'index.php?secretary/student_add/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']           = $this->input->post('name');
            $data['birthday']       = $this->input->post('birthday');
            ...
            redirect(base_url() . 'index.php?secretary/student_information/' . $param3, 'refresh');
        } 
        ...
        if ($param2 == 'delete') {
            ...
            redirect(base_url() . 'index.php?secretary/student_information/' . $param1, 'refresh');
        }
    }
    ...
    function student_promotion($param1 = '' , $param2 = '')
    {
        ...
        if($param1 == 'promote') {
            ...
            redirect(base_url() . 'index.php?secretary/student_promotion' , 'refresh');
        }
    ...
    function get_students_to_promote($class_id_from , $class_id_to , $running_year , $promotion_year)
    {
        ...
        $this->load->view('backend/secretary/student_promotion_selector' , $page_data);
    }


     /****MENAXHIMI I PRINDERVE*****/
    function parent($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            $this->email_model->account_opening_email('parent', $data['email']); //DERGOHET EMAIL
            redirect(base_url() . 'index.php?secretary/parent/', 'refresh');
        }
        if ($param1 == 'edit') {
            $data['name']                   = $this->input->post('name');
            $data['email']                  = $this->input->post('email');
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            $this->email_model->account_opening_email('teacher', $data['email']); //DERGOHET EMAIL
            redirect(base_url() . 'index.php?secretary/teacher/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['birthday']    = $this->input->post('birthday');
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/subject/'.$data['class_id'], 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']       = $this->input->post('name');
            $data['class_id']   = $this->input->post('class_id');
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?secretary/subject/'.$param3, 'refresh');
        }
    ...
    function classes($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            //krijohet nje cikel si rregull standart
            $data2['class_id']  =   $class_id;
            $data2['name']      =   'A';
            $this->db->insert('section' , $data2);

            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/classes/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = $this->input->post('name');
            $data['name_numeric'] = $this->input->post('name_numeric');
    ...
    function upload_academic_syllabus()
    {
        ...
        //ngarkohen skedare duke perdorur codeigniter upload library
        ...
        redirect(base_url() . 'index.php?secretary/academic_syllabus/' . $data['class_id'] , 'refresh');
    ...
    function sections($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/section/' . $data['class_id'] , 'refresh');
        }
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?secretary/section' , 'refresh');
        }
    }
    ...
    function exam($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/exam/', 'refresh');
        }
    ...
    function exam_marks_sms($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'send_sms') {
            ...
            // terheq te gjithe nxenesit e klases se perzgjedhur
            $students = $this->db->get_where('enroll' , array(
                'class_id' => $class_id,
                    'year' => $this->db->get_where('settings' , array('type' => 'running_year'))->row()->description
            ))->result_array();
            // terheq piket e nxenesit per provimin e perzgjedhur
            foreach ($students as $row) {
                if ($receiver == 'student')
            ...
            redirect(base_url() . 'index.php?secretary/exam_marks_sms' , 'refresh');
        }
    ...
    /****MENAXHIMI I PIKEVE TE PROVIMIT*****/
    function marks2($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0) {
                redirect(base_url() . 'index.php?secretary/marks2/' . $page_data['exam_id'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose exam, class and subject');
                redirect(base_url() . 'index.php?secretary/marks2/', 'refresh');
            }
        }
        if ($this->input->post('operation') == 'update') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?secretary/marks2/' . $this->input->post('exam_id') . '/' . $this->input->post('class_id') . '/' . $this->input->post('subject_id'), 'refresh');
        }
        $page_data['exam_id']    = $exam_id;
        $page_data['class_id']   = $class_id;
    ...
    function marks_selector()
    {
        ...
        redirect(base_url() . 'index.php?secretary/marks_manage_view/' . $data['exam_id'] . '/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['subject_id'] , 'refresh');
    ...
    function marks_update($exam_id = '' , $class_id = '' , $section_id = '' , $subject_id = '')
    {
        ...
        redirect(base_url().'index.php?secretary/marks_manage_view/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id , 'refresh');
    }

    function marks_get_subject($class_id)
    {
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/secretary/marks_get_subject' , $page_data);
    }

    // TABELIMI I PASQYRAVE TE PERMBAJTJEVE
    function tabulation_sheet($class_id = '' , $exam_id = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0) {
                redirect(base_url() . 'index.php?secretary/tabulation_sheet/' . $page_data['class_id'] . '/' . $page_data['exam_id'] , 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose class and exam');
                redirect(base_url() . 'index.php?secretary/tabulation_sheet/', 'refresh');
            }
        }
        $page_data['exam_id']    = $exam_id;
        $page_data['class_id']   = $class_id;
    ...
    function tabulation_sheet_print_view($class_id , $exam_id) {
        ...
        $page_data['class_id'] = $class_id;
        $page_data['exam_id']  = $exam_id;
        $this->load->view('backend/secretary/tabulation_sheet_print_view' , $page_data);
    }
    ...
    function grade($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/grade/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['grade_point'] = $this->input->post('grade_point');
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/class_routine_add/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['class_id']       = $this->input->post('class_id');
            if($this->input->post('section_id') != '') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?secretary/class_routine_view/' . $data['class_id'], 'refresh');
        } else if ($param1 == 'edit') {
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?secretary/class_routine_view/' . $class_id, 'refresh');
        }
    ...
    function class_routine_print_view($class_id , $section_id)
    {
        ...
        $page_data['class_id']   =   $class_id;
        $page_data['section_id'] =   $section_id;
        $this->load->view('backend/secretary/class_routine_print_view' , $page_data);
    }

    function get_class_section_subject($class_id)
    {
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/secretary/class_routine_section_subject_selector' , $page_data);
    }
    ...
    function section_subject_edit($class_id , $class_routine_id)
    {
        ...
        $this->load->view('backend/secretary/class_routine_section_subject_edit' , $page_data);
    }
    ...
    function get_section($class_id) {
          $page_data['class_id'] = $class_id; 
          $this->load->view('backend/secretary/manage_attendance_section_holder' , $page_data);
    }
    function attendance_selector()
    {
        ...
        redirect(base_url().'index.php?secretary/manage_attendance_view/'.$data['class_id'].'/'.$data['section_id'].'/'.$data['timestamp'],'refresh');
    }
        ...
        foreach($attendance_of_students as $row) {
            ...
            if ($attendance_status == 2) {
                ...
                if ($active_sms_service != '' || $active_sms_service != 'disabled') {
                    ...
                    $message        = 'Femija juaj' . ', ' . $student_name . ', nuk eshte paraqitur sot ne shkolle.';
                    $this->sms_model->send_sms($message,$receiver_phone);
                }
            }
        }
        $this->session->set_flashdata('flash_message' , get_phrase('attendance_updated'));
        redirect(base_url().'index.php?secretary/manage_attendance_view/'.$class_id.'/'.$section_id.'/'.$timestamp , 'refresh');
    }
	...
	function manage_attendance2($date='',$month='',$year='',$class_id='' , $section_id = '' , $session = '')
	{
		...
		if($_POST)
		{
			// Perzgjedh nxenesit e klases $class_id
			...
			$this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
			redirect(base_url() . 'index.php?secretary/manage_attendance/'.$date.'/'.$month.'/'.$year.'/'.$class_id.'/'.$section_id.'/'.$session , 'refresh');
		}
        $page_data['date']       =	$date;
	...
	function attendance_selector2()
	{
		...
		redirect(base_url() . 'index.php?secretary/manage_attendance/'.$this->input->post('date').'/'.
     ...
     function attendance_report_print_view($class_id ='' , $section_id = '' , $month = '') {
        ...
        $page_data['section_id']  = $section_id;
        $page_data['month'] = $month;
        $this->load->view('backend/secretary/attendance_report_print_view' , $page_data);
    }
    ...
    function attendance_report_selector()
    {
        ...
        $data['section_id'] = $this->input->post('section_id');
        redirect(base_url().'index.php?secretary/attendance_report_view/'.$data['class_id'].'/'.$data['section_id'].'/'.$data['month'],'refresh');
    }
    
	/****MENAXHIMI I LOGARITAREVE*****/
    function accountant($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $teacher_id = $this->db->insert_id();
            move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/accountant_image/' . $teacher_id . '.jpg');
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            $this->email_model->account_opening_email('accountant', $data['email']); //DERGOHET EMAIL
            redirect(base_url() . 'index.php?secretary/accountant/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['birthday']    = $this->input->post('birthday');
    ...
    /******MENAXHIMI I PAGESAVE / FATURAVE ME STATUS*****/
    function invoice($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/student_payment', 'refresh');
        }
        ...
        if ($param1 == 'do_update') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?secretary/invoice', 'refresh');
        } else if ($param1 == 'edit') {
        ...
        if ($param1 == 'take_payment') {
            ...
            redirect(base_url() . 'index.php?secretary/income/', 'refresh');
        }
    ...
    function expense($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->db->insert('payment' , $data);
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/expense', 'refresh');
        }
    ...
    function expense_category($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/expense_category');
        }
        if ($param1 == 'edit') {
            $data['name']   =   $this->input->post('name');
    ...
    /**********MENAXHIMI I BIBLIOTEKES / LIBRAVE********************/
    function book($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/book', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['description'] = $this->input->post('description');
    ...
    /**********MENAXHIMI I TRANSPORTIT / MJETE / LINJAT********************/
    function transport($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/transport', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['route_name']        = $this->input->post('route_name');
            $data['number_of_vehicle'] = $this->input->post('number_of_vehicle');
    ...
    /**********MENAXHIMI I KONVIKTIT / FJETINAT / DHOMAT ********************/
    function dormitory($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/dormitory', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']           = $this->input->post('name');
            $data['number_of_room'] = $this->input->post('number_of_room');
    ...
    /***MENAXHIMI I EVENTEVE / NJOFTIMET, DO TE JENE TE DUKSHME NE PLATFORMAT E ÇDO PERDORUESI**/
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            if ($check_sms_send == 5) {
                // konfigurimet e dergimit te sms 
                ...
                $message .= get_phrase('on') . ' ' . $date . ' ' . $data['notice'];
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?secretary/noticeboard/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['notice_title']     = $this->input->post('notice_title');
            $data['notice']           = $this->input->post('notice');
    ...
    function message($param1 = 'message_home', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'send_new') {
            ...
            $this->session->set_flashdata('flash_message', get_phrase('message_sent!'));
            redirect(base_url() . 'index.php?secretary/message/message_read/' . $message_thread_code, 'refresh');
        }

        if ($param1 == 'send_reply') {
            $this->crud_model->send_reply_message($param2);  //$param2 = message_thread_code
            $this->session->set_flashdata('flash_message', get_phrase('message_sent!'));
            redirect(base_url() . 'index.php?secretary/message/message_read/' . $param2, 'refresh');
        }
	...
	/****** SMS SIPAS DESHIRES********/
    function custom_sms($param1 = '' , $param2 = '')
    {
        if ($this->session->userdata('secretary_login') != 1)
            redirect(base_url(), 'refresh');
        ...
        if ($param1 == 'send_sms') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('message_sent'));
            redirect(base_url() . 'index.php?secretary/custom_sms' , 'refresh');
        }
                
        $page_data['page_name']  = 'custom_sms';
        $page_data['page_title'] = get_phrase('custom_sms');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'do_update') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated')); 
            redirect(base_url() . 'index.php?secretary/system_settings/', 'refresh');
        }
    ...
    {
        $this->load->view('backend/secretary/change_session');
    }
	...
	function update( $task = '', $purchase_code = '' ) {
        ...
        // Dekompreso skedaret e perditesimit dhe hiq skedarin zip te ngarkuar.
        $zip = new ZipArchive;
        $res = $zip->open($path);
        if ($res === TRUE) {
		...
		// Ekzekuto modifikimet php 
		require './update/' . $unzipped_file_name . '/update_script.php';
        
        // Krijo direktori te reja.
        ...
        redirect(base_url() . 'index.php?secretary/system_settings');
    }
    ...
    function sms_settings($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'clickatell') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?secretary/sms_settings/', 'refresh');
        }
    ...
    function manage_language($param1 = '', $param2 = '', $param3 = '')
    {
		...
		if ($param1 == 'update_phrase') {
			...
			redirect(base_url() . 'index.php?secretary/manage_language/edit_phrase/'.$language, 'refresh');
		}
		if ($param1 == 'do_update') {
			...
			$this->session->set_flashdata('flash_message', get_phrase('settings_updated'));
			redirect(base_url() . 'index.php?secretary/manage_language/', 'refresh');
		}
    ...
    function backup_restore($operation = '', $type = '')
    {
        ...
        if ($operation == 'restore') {
            ...
            redirect(base_url() . 'index.php?secretary/backup_restore/', 'refresh');
        }
        if ($operation == 'delete') {
    ...
    /******MENAXHIMI I PROFILIT DHE NDRYSHIMI I PASWORDIT***/
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            $this->db->where('secretary_id', $this->session->userdata('secretary_id'));
            $this->db->update('secretary', $data);
            move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/secretary_image/' . $this->session->userdata('secretary_id') . '.jpg');
            $this->session->set_flashdata('flash_message', get_phrase('account_updated'));
            redirect(base_url() . 'index.php?secretary/manage_profile/', 'refresh');
        }
        if ($param1 == 'change_password') {
            ...
            $current_password = $this->db->get_where('secretary', array(
                'secretary_id' => $this->session->userdata('secretary_id')
            ))->row()->password;
            if ($current_password == $data['password'] && $data['new_password'] == $data['confirm_new_password']) {
                $this->db->where('secretary_id', $this->session->userdata('secretary_id'));
                $this->db->update('secretary', array(
        ...
        $page_data['edit_data']  = $this->db->get_where('secretary', array(
            'secretary_id' => $this->session->userdata('secretary_id')
        ))->result_array();
        $this->load->view('backend/index', $page_data);
    }
