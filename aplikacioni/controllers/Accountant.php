...
class Accountant extends CI_Controller
{
    ...
    /*     * * funksioni default, redirekton ne faqen login nese asnje llogaritar nuk eshte loguar ende ** */
	...
	function student_bulk_add($param1 = '')
	{
        ...
        if($param1 == 'add_bulk_student') {
            ...
            redirect(base_url() . 'index.php?accountant/student_information/' . $this->input->post('class_id') , 'refresh');
        }			
    ...
    function get_sections($class_id)
    {
        ...
        $this->load->view('backend/accountant/student_bulk_add_sections' , $page_data);
    }
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?accountant/student_add/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']           = $this->input->post('name');
            $data['birthday']       = $this->input->post('birthday');
            ...
            redirect(base_url() . 'index.php?accountant/student_information/' . $param3, 'refresh');
        } 
    ...
    function student_promotion($param1 = '' , $param2 = '')
    {
        ...
        if($param1 == 'promote') {
            ...
            redirect(base_url() . 'index.php?accountant/student_promotion' , 'refresh');
        }
    ...
    function get_students_to_promote($class_id_from , $class_id_to , $running_year , $promotion_year)
    {
        ...
        $this->load->view('backend/accountant/student_promotion_selector' , $page_data);
    }
    ...
    function parent($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?accountant/parent/', 'refresh');
        }
        if ($param1 == 'edit') {
            $data['name']                   = $this->input->post('name');
            $data['email']                  = $this->input->post('email');
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?accountant/teacher/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['birthday']    = $this->input->post('birthday');
    ...
    function classes($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?accountant/classes/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = $this->input->post('name');
            $data['name_numeric'] = $this->input->post('name_numeric');
    ...
    function upload_academic_syllabus()
    {
        ...
        redirect(base_url() . 'index.php?accountant/academic_syllabus/' . $data['class_id'] , 'refresh');
    ...
    function sections($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?accountant/section/' . $data['class_id'] , 'refresh');
        }
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?accountant/section' , 'refresh');
        }
    }
    ...
    function exam($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?accountant/exam/', 'refresh');
        }
    ...
    /****** DERGIMI I PAGESAVE ME SMS ********/
    function send_invoice_sms($param1 = '' , $param2 = '')
    {
        if ($this->session->userdata('accountant_login') != 1)
            redirect(base_url(), 'refresh');
        ...
        if ($param1 == 'send_sms') {
            ...
            // terheq pagesat e nxenesit per vitin e perzgjedhur
            foreach ($students as $row) {
                if ($receiver == 'student')
                ...
                $payments = $this->db->get_where('payment' , array('year' => $this->db->get_where('settings' , array('type' => 'running_year'))->row()->description))->result_array();
                $message = '';
                foreach ($payments as $row2) {
                    $payment       = $this->db->get_where('payment' , array('payment_id' => $row2['payment_id']))->row()->title;
                    $amount = $row2['amount'];  
                    $message      .= $row2['student_id'] . $payment . ' : ' . $amount . ' , ';
            ...
            redirect(base_url() . 'index.php?accountant/send_invoice_sms' , 'refresh');
        }
                
        $page_data['page_name']  = 'send_invoice_sms';
        $page_data['page_title'] = get_phrase('send_invoice_sms');
        $this->load->view('backend/index', $page_data);
    }

    /****MENXHIMI I PIKEVE TE PROVIMIT*****/
    function marks2($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0) {
                redirect(base_url() . 'index.php?accountant/marks2/' . $page_data['exam_id'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose exam, class and subject');
                redirect(base_url() . 'index.php?accountant/marks2/', 'refresh');
            }
        }
        if ($this->input->post('operation') == 'update') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?accountant/marks2/' . $this->input->post('exam_id') . '/' . $this->input->post('class_id') . '/' . $this->input->post('subject_id'), 'refresh');
        }
        $page_data['exam_id']    = $exam_id;
        $page_data['class_id']   = $class_id;
    ...
    function marks_selector()
    {
        ...
        redirect(base_url() . 'index.php?accountant/marks_manage_view/' . $data['exam_id'] . '/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['subject_id'] , 'refresh');
    ...
    function marks_update($exam_id = '' , $class_id = '' , $section_id = '' , $subject_id = '')
    {
        ...
        redirect(base_url().'index.php?accountant/marks_manage_view/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id , 'refresh');
    }

    function marks_get_subject($class_id)
    {
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/accountant/marks_get_subject' , $page_data);
    }
    ...
    function tabulation_sheet($class_id = '' , $exam_id = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0) {
                redirect(base_url() . 'index.php?accountant/tabulation_sheet/' . $page_data['class_id'] . '/' . $page_data['exam_id'] , 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose class and exam');
                redirect(base_url() . 'index.php?accountant/tabulation_sheet/', 'refresh');
            }
        }
        $page_data['exam_id']    = $exam_id;
        $page_data['class_id']   = $class_id;
    ...
    function tabulation_sheet_print_view($class_id , $exam_id) {
        ...
        $page_data['class_id'] = $class_id;
        $page_data['exam_id']  = $exam_id;
        $this->load->view('backend/accountant/tabulation_sheet_print_view' , $page_data);
    }
    ...
    function grade($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?accountant/grade/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['grade_point'] = $this->input->post('grade_point');
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?accountant/class_routine_add/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['class_id']       = $this->input->post('class_id');
            if($this->input->post('section_id') != '') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?accountant/class_routine_view/' . $data['class_id'], 'refresh');
        } else if ($param1 == 'edit') {
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?accountant/class_routine_view/' . $class_id, 'refresh');
        }
    ...
    function class_routine_print_view($class_id , $section_id)
    {
        ...
        $page_data['class_id']   =   $class_id;
        $page_data['section_id'] =   $section_id;
        $this->load->view('backend/accountant/class_routine_print_view' , $page_data);
    }

    function get_class_section_subject($class_id)
    {
        $page_data['class_id'] = $class_id;
        $this->load->view('backend/accountant/class_routine_section_subject_selector' , $page_data);
    }
    ...
    function section_subject_edit($class_id , $class_routine_id)
    {
        ...
        $this->load->view('backend/accountant/class_routine_section_subject_edit' , $page_data);
    }
    ...
    function get_section($class_id) {
          $page_data['class_id'] = $class_id; 
          $this->load->view('backend/accountant/manage_attendance_section_holder' , $page_data);
    }
    function attendance_selector()
    {
        ...
        redirect(base_url().'index.php?accountant/manage_attendance_view/'.$data['class_id'].'/'.$data['section_id'].'/'.$data['timestamp'],'refresh');
    }
    ...
    function attendance_update($class_id = '' , $section_id = '' , $timestamp = '')
    {
        ...
        redirect(base_url().'index.php?accountant/manage_attendance_view/'.$class_id.'/'.$section_id.'/'.$timestamp , 'refresh');
    }
	...
	function manage_attendance2($date='',$month='',$year='',$class_id='' , $section_id = '' , $session = '')
	{
		...
		if($_POST)
		{
			...
			$this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
			redirect(base_url() . 'index.php?accountant/manage_attendance/'.$date.'/'.$month.'/'.$year.'/'.$class_id.'/'.$section_id.'/'.$session , 'refresh');
		}
        $page_data['date']       =	$date;
	...
	function attendance_selector2()
	{
     ...
     function attendance_report_print_view($class_id ='' , $section_id = '' , $month = '') {
        ...
        $page_data['section_id']  = $section_id;
        $page_data['month'] = $month;
        $this->load->view('backend/accountant/attendance_report_print_view' , $page_data);
    }
    ...
    function attendance_report_selector()
    {
        ...
        $data['section_id'] = $this->input->post('section_id');
        redirect(base_url().'index.php?accountant/attendance_report_view/'.$data['class_id'].'/'.$data['section_id'].'/'.$data['month'],'refresh');
    }
    ...
    function accountant($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?accountant/accountant/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['birthday']    = $this->input->post('birthday');
    ...
    function book($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?accountant/book', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['description'] = $this->input->post('description');
    ...
    function transport($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?accountant/transport', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['route_name']        = $this->input->post('route_name');
            $data['number_of_vehicle'] = $this->input->post('number_of_vehicle');
    ...
    function dormitory($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?accountant/dormitory', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']           = $this->input->post('name');
            $data['number_of_room'] = $this->input->post('number_of_room');
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'do_update') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated')); 
            redirect(base_url() . 'index.php?accountant/system_settings/', 'refresh');
        }
    ...
    {
        $this->load->view('backend/accountant/change_session');
    }
	...
	function update( $task = '', $purchase_code = '' ) {
        ...
        redirect(base_url() . 'index.php?accountant/system_settings');
    }
    ...
    function sms_settings($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'clickatell') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?accountant/sms_settings/', 'refresh');
        }
    ...
    function manage_language($param1 = '', $param2 = '', $param3 = '')
    {
		...
		if ($param1 == 'update_phrase') {
			...
			redirect(base_url() . 'index.php?accountant/manage_language/edit_phrase/'.$language, 'refresh');
		}
		if ($param1 == 'do_update') {
			...
			$this->session->set_flashdata('flash_message', get_phrase('settings_updated'));
			redirect(base_url() . 'index.php?accountant/manage_language/', 'refresh');
		}
